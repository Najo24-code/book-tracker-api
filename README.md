<code>book-tracker-api</code>

# BookTracker — Reading List Management API
...
A RESTful API for managing a personal reading list with user authentication, CRUD operations, and a responsive SPA frontend. Built with FastAPI, SQLAlchemy, and JWT authentication.
...
```bash
git clone https://github.com/Najo24-code/book-tracker-api.git
cd book-tracker-api
docker-compose up -d
```
...
# Run
docker run -p 8000:8000 book-tracker-api
```
